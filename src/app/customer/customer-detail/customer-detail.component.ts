...
@Component({
    ...
    styleUrls: ['./customer-detail.component.css', '../../shared/shared-new-form.css', '../../shared/common.css'],
})
export class CustomerDetailComponent implements OnInit, OnDestroy {
    ...
    getCustomerByReference(reference) {
        ...
        this.customersService
            .getCustomerByReference(reference.trim())
    ...
    handleFailCustomer(error, reference) {
    ...
    getFormControl(fControlName: string) {
        return fControlName === 'phone' || fControlName === 'countryCode'
            ? this.addEditCustomerForm.get('phoneGroup').get(fControlName)
    ...
    getCustomerDetails(): ICustomer {
        ...
        Object.entries(customerDetails).forEach((key) => {
            ...
            if (attributeName === 'registeredName' || attributeName === 'registeredNumber') {
                customerDetails[attributeName] =
                    this.getFormControl('type').value === 'PERSONAL'
                        ? ''
