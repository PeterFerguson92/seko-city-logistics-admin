...
export const GH_DESTINATIONS = ['ACCRA', 'KUMASI', 'CAPECOAST', 'SEKONDI-TAKORADI',
  'TEMA', 'KOFORIDUA', 'SUNYANI', 'MADINA', 'AKIM ODA', 'WINNEBA', 'OTHER'
]
...
export const BOOKING_ITEMS = [
  { SMALL_BOX: { DISPLAY_NAME: 'SMALL BOX', PRICE: '10' } },
  { MEDIUM_BOX: { DISPLAY_NAME: 'MEDIUM BOX', PRICE: '20' } },
  { BIG_BOX: { DISPLAY_NAME: 'BIG BOX', PRICE: '30' } }
]
