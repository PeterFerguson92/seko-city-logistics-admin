...
export const GH_DESTINATIONS = ['TBD', 'ACCRA', 'ADENTA', 'ADENTA EAST', 'AFLAO', 'AGOGO', 'AGONA SWEDRU', 'AKIM ODA', 'AKOSOMBO',
...
export const PAYMENT_STATUSES = [TO_BE_DEFINED, FULL_PAYMENT_STATUS_ALIAS,PARTIAL_PAYMENT_STATUS_ALIAS, NO_PAYMENT_PAYMENT_STATUS_ALIAS]
