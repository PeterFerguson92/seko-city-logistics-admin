...
export const GH_DESTINATIONS = ['ACCRA', 'ADENTA', 'ADENTA EAST', 'AFLAO', 'AGOGO', 'AGONA SWEDRU', 'AKIM ODA', 'AKOSOMBO',
  'ASAMANKESE', 'ASHIAMAN', 'BAWKU', 'BEREKUM', 'BOLGATANGA', 'CAPE COAST', 'DAMBAI', 'DAMOGO', 'DOME', 'EFFIAKUMA', 'EJURA',
  'GOASO', 'HO', 'HOHOE', 'KASOA', 'KINTAMPO', 'KOFORIDUA', 'KONONGO', 'KUMASI', 'MADINA', 'MAMPONG', 'NALERIGU', 'NKAWKAW', 'NSAWAM',
  'NUNGUA', 'OBUASI', 'ODUPONKPEHE', 'PRESTEA', 'SAVELUGU', 'SEFWI WIAWSO', 'SEKONDI', 'SEKONDI-TAKORADI', 'SAHUM', 'SUNYANI', 'TAFO', 'TAIFA',
  'TAKORADI', 'TAMALE','TARKWA', 'TECHIMAN', 'TEMA', 'TESHIE', 'WA', 'WENCHI', 'WINNEBA', 'YENDI','OTHER']
...
export const PAYMENT_STATUSES = [FULL_PAYMENT_STATUS_ALIAS,PARTIAL_PAYMENT_STATUS_ALIAS, NO_PAYMENT_PAYMENT_STATUS_ALIAS]
...
export const ORDER_ITEMS = [{ DISPLAY_NAME: 'BARRELS', PRICE: '40' },
  { DISPLAY_NAME: 'LARGE SHIPPING BOXES', PRICE: '7' }, { DISPLAY_NAME: 'MEDIUM SHIPPING BOXES', PRICE: '5' }];
export const ORDER_STATUSES = ['CREATED', 'DELIVERED']
