...
export const ITEM_STATUSES = ['COLLECTED', 'PROCESSING', 'IN TRANSIT', 'ARRIVED', 'DELIVERED', 'CLOSED'];
...
export const DISCOUNT_REASONS = ['NO DISCOUNT APPLIED', 'DISCOUNT APPLIED'];
...
export const ORDER_PICKUP_TIMES = ['TO BE CONFIRMED', 'MORNING', 'AFTERNOON', 'EVENING'];
...
export const ORDER_ITEMS = [
    ...
    { DISPLAY_NAME: 'LARGE SHIPPING BOXES', PRICE: '8' },
    { DISPLAY_NAME: 'MEDIUM SHIPPING BOXES', PRICE: '6' },
];
