...
export class BookingSummaryComponent implements OnInit, OnDestroy {
    ...
    async processBookingInfo(rawBooking) {
        ...
        this.booking.sender = (
            await lastValueFrom(this.customersService.getCustomerByReference(this.booking.senderReference))
        ).data.customerByReference;
        this.booking.receivers = (
            await lastValueFrom(this.customersService.getCustomersByReferences(this.booking.receiverReferences))
        ).data.customersByReferences;
        this.booking.items = (
    ...
    async getItems() {
        return (await lastValueFrom(this.itemService.getItemsByBookingReference(this.booking.reference))).data
            .itemsByBookingReference;
    }
    ...
    getDiscountAmount() {
        return this.commonService.getDiscountAmount(this.booking.discountType, this.booking.discountAmount);
    }
