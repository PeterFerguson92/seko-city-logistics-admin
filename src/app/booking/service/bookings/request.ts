...
export const BOOKING_FRAGMENT = gql`
      ...
      totalAmount fullAmount amountPaid amountOutstanding discountAmount discountReason discountType isDiscountApplied paymentType paymentStatus paymentNotes
