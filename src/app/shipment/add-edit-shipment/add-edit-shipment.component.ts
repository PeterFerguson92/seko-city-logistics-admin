...
export class AddEditShipmentComponent implements OnInit, OnDestroy {
                ...
                next: (result) => {
                    ...
                    if (this.shipment) {
                        this.addEditShipmentForm.patchValue({
                            ...
                            exporterAddress: this.shipment.exporterAddress,
    ...
    updateShipment() {
        ...
        if (updateCustomerFields.length > 0) {
            this.shipmentService
                .updateShipment(this.shipment.reference, updateCustomerFields)
                .pipe(takeUntil(this.componentDestroyed$))
                .subscribe({
                    next: () => {
    ...
    createShipment() {
        ...
        const shipment = {
            ...
            exporterAddress: this.getFormControl('exporterAddress').value,
